<template>
    <header class="">
        <div class="container mx-auto px-6 py-24 flex bg-white">
            <div class=" max-w-4xl">
                ...
                <nuxt-link to="https://app.wenite.io/login">
                    <button type="button" class="header-book-demo">Book a demo
                        <Icon name="system-uicons:arrow-right" class="-mt-1" size="28" />
                    </button>
                    <button type="button" class="header-btn-book">Get started free
                        <Icon name="system-uicons:arrow-right" class="-mt-1" size="28" />
                    </button>
                </nuxt-link>
            </div>
            <div class="mx-auto justify-center pt-32 items-center rounded-full">
                <img src="~/assets/images/tryout2.gif" class="" alt="">
            </div>
